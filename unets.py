...
# TODO: check usage in original repo code
...
class R2U_Net(nn.Module):
    ...
    def forward(self, x):
        # print("R2U_Net forward:", type(x))
        # print("R2U_Net forward:", x.shape)
        ...
        # print("R2U_Net forward:", "encoding", type(x))
        # print("R2U_Net forward:", "encoding", x.shape)
        ...
        # print("R2U_Net forward:", "decoding", type(x))
        # print("R2U_Net forward:", "decoding", x.shape)
...
class AttU_Net(nn.Module):
    ...
    def forward(self, x):
        print("AttU_Net forward:", type(x))
        print("AttU_Net forward:", x.shape)
        ...
        x5 = self.Maxpool(x4)
        x5 = self.Conv5(x5)
        print("AttU_Net forward:", "encoding", type(x5))
        print("AttU_Net forward:", "encoding", x5.shape)
        ...
        d1 = self.Conv_1x1(d2)
        print("AttU_Net forward:", "decoding", type(d2))
        print("AttU_Net forward:", "decoding", d2.shape)
        return d1
...
class R2AttU_Net(nn.Module):
    ...
    def forward(self, x):
        print("R2AttU_Net forward:", type(x))
        print("R2AttU_Net forward:", x.shape)
        ...
        x5 = self.Maxpool(x4)
        x5 = self.RRCNN5(x5)
        print("R2AttU_Net forward:", "encoding", type(x5))
        print("R2AttU_Net forward:", "encoding", x5.shape)
        ...
        d1 = self.Conv_1x1(d2)
        print("R2AttU_Net forward:", "encoding", type(x))
        print("R2AttU_Net forward:", "encoding", x.shape)
...
Shamelessly taken from https://github.com/milesial/Pytorch-UNet which
is under GNU-GPL license.
"""

class UNetciccio(nn.Module):
    def __init__(self, n_channels, n_classes):
        super(UNetciccio, self).__init__()
